...
> SDK 53 introduced [Protected routes](/router/advanced/protected), a more powerful method of handling authentication. Please follow this guide if you are using SDK 52 and earlier.

[Building an Auth Flow with Expo Router](https://www.youtube.com/watch?v=yNaOaR2kIa0) — Learn how to implement an auth flow in your Expo Router project.
