...
[Deploy native servers to EAS](/router/web/api-routes#native-deployment) — Deploy and link versioned servers to your production native apps.
...
-   [`generateStaticParams`](/router/web/static-rendering#generatestaticparams) is only partially supported in full React Server Components mode.
