...
[Introduction to Expo Router Layout Files](https://www.youtube.com/watch?v=Yh6Qlg2CYwQ) — What are layout files, how to navigate between screens, and block access using redirects.
