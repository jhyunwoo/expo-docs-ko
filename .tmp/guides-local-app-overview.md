...
[Create a debug build locally](/guides/local-app-development) — Learn how to create a debug build for your Expo app locally.
...
[Create a release build locally](/guides/local-app-production) — Generate signed Android App Bundles, archive iOS builds in Xcode, and submit them manually to app stores.
...
[Use build cache providers](/guides/cache-builds-remotely) — Enable EAS build caching or ship a custom provider to shorten local build times.
...
[Prebuilt Expo Modules for Android](/guides/prebuilt-expo-modules) — Understand how prebuilt modules work and learn how to opt out globally or per package.
