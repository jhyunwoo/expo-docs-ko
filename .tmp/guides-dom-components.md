...
> This is in alpha and may change in the future.
...
> **Warning:** This is in alpha and may change in the future. Public assets are not supported in EAS Update. Use `require()` to load local assets instead.
