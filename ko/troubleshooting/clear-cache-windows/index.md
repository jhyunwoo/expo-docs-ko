...
title: Windows에서 bundler cache 비우기
description: Windows에서 Expo CLI 또는 React Native CLI와 함께 Yarn 또는 npm을 사용할 때 bundler cache를 비우는 방법을 알아보세요.
---

# Windows에서 bundler cache 비우기

Windows에서 Expo CLI 또는 React Native CLI와 함께 Yarn 또는 npm을 사용할 때 bundler cache를 비우는 방법을 알아보세요.

> macOS 또는 Linux에서 development cache를 비워야 하나요? [여기에서 관련 명령어를 확인하세요.](/troubleshooting/clear-cache-macos-linux)
...
| Command | Description |
| --- | --- |
| `del node_modules` | 프로젝트의 모든 dependency를 삭제합니다 |
...
| `del %localappdata%\Temp/<cache>` | 지정한 packager/bundler cache 파일 또는 디렉터리를 비웁니다 |
